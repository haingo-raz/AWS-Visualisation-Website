...
function getNewsData(teamName) {
    return __awaiter(this, void 0, void 0, function () {
        var NewsAPIUrl, id, dataResponse, articles, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    NewsAPIUrl = "".concat(baseUrl, "/everything?q=").concat(teamName, "&language=en&sortBy=publishedAt&apiKey=").concat(apiKey);
                    id = 0;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
